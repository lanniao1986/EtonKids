...
public class DownloadManager extends Thread {
    ...
    private void broadcastAddTask(String url, boolean isInterrupt) {
        ...
        Intent nofityIntent = new Intent("com.enix.hoken.custom.download.DownloadListActivity");
    ...
    public synchronized void completeTask(DownloadTask task) {
        ...
        if (mDownloadingTasks.contains(task)) {
            ...
            // notify list changed
            Intent nofityIntent = new Intent("com.enix.hoken.custom.download.DownloadListActivity");
            nofityIntent.putExtra(DownLoadIntents.TYPE, DownLoadIntents.Types.COMPLETE);
    ...
    private DownloadTask newDownloadTask(String url) throws MalformedURLException {
        ...
        DownloadTaskListener taskListener = new DownloadTaskListener() {
            ...
            public void updateProcess(DownloadTask task) {
                ...
                Intent updateIntent = new Intent(
                        "com.enix.hoken.custom.download.DownloadListActivity");
                updateIntent.putExtra(DownLoadIntents.TYPE, DownLoadIntents.Types.PROCESS);
                updateIntent.putExtra(DownLoadIntents.PROCESS_SPEED, task.getDownloadSpeed() + "kbps | "
                        + task.getDownloadSize() + " / " + task.getTotalSize());
                updateIntent.putExtra(DownLoadIntents.PROCESS_PROGRESS, task.getDownloadPercent() + "");
            ...
            public void errorDownload(DownloadTask task, Throwable error) {
                ...
                // Intent("com.enix.hoken.custom.download.DownloadListActivity");
        ...
        return new DownloadTask(mContext, url, CommonUtil.getDownLoadPath(), taskListener);
    }
