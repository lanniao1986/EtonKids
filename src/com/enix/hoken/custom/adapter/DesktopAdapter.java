...
import com.enix.hoken.custom.item.Desktop;
...
public class DesktopAdapter extends BaseExpandableListAdapter {
	...
	public View getChildView(int groupPosition, int childPosition,
		...
		if (convertView == null) {
			...
			holder.mFlag =  (ImageView) convertView
			.findViewById(R.id.desktop_list_child_flag);
		...
		if (childPosition == Desktop.mChooesId && groupPosition == 0) {
			...
			holder.mFlag.setVisibility(View.INVISIBLE);
		}
		return convertView;
	}
