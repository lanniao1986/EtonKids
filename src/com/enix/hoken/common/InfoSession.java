...
public class InfoSession {
	...
	public static final String TBL_NAME_BINFO = "TBL_BINFO";
	public static final String TBL_NAME_TINFO = "TBL_TINFO";
	public static final String TBL_NAME_SINFO = "TBL_SINFO";
	public static final String TBL_NAME_PINFO = "TBL_PINFO";
	public static final String TBL_NAME_GROUP = "TBL_GROUP";
	public static final String TBL_NAME_CINFO = "TBL_CINFO";
