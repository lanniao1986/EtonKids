 ...
 * Original file: G:\\WorkSpace\\EtonKids\\src\\com\\enix\\hoken\\custom\\download\\services\\IDownloadService.aidl
 */
package com.enix.hoken.custom.download.services;
public interface IDownloadService extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements com.enix.hoken.custom.download.services.IDownloadService
{
private static final java.lang.String DESCRIPTOR = "com.enix.hoken.custom.download.services.IDownloadService";
...
/**
 * Cast an IBinder object into an com.enix.hoken.custom.download.services.IDownloadService interface,
 * generating a proxy if needed.
 */
public static com.enix.hoken.custom.download.services.IDownloadService asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof com.enix.hoken.custom.download.services.IDownloadService))) {
return ((com.enix.hoken.custom.download.services.IDownloadService)iin);
}
return new com.enix.hoken.custom.download.services.IDownloadService.Stub.Proxy(obj);
}
...
private static class Proxy implements com.enix.hoken.custom.download.services.IDownloadService
{
